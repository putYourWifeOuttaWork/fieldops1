/*
  # Add Company Admin Site Management Capabilities
  
  1. Changes
    - Update RLS policies to allow company admins to delete sites and submissions
    - Create helper functions for checking company admin access to program resources
    - Ensure company admins can manage content owned by their company
    
  2. Security
    - Maintains existing role-based permissions
    - Only allows company admins to manage sites/submissions within their company's programs
*/
