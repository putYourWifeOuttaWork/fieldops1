/*
  # Fix Template Observations in Submission Sessions
  
  1. Problem
    - Observations are not being created from templates
    - NULL values for image_url and other fields causing issues
    - Casting errors for NULL measure values
  
  2. Changes
    - Update create_submission_session function to properly handle NULL values
    - Ensure all required fields have proper defaults
    - Fix error handling and NULL image_url support
