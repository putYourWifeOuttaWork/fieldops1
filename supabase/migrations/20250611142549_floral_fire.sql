/*
  # Add Outdoor Environmental Data to Observations
  
  1. New Columns
    - Add outdoor_temperature and outdoor_humidity columns to petri_observations and gasifier_observations
    - These columns store environmental data at the time each observation is made
    - Used for more granular analysis than the submission-level environmental data
    
  2. Changes
    - Add the new columns to both observation tables
    - Update the format_object_state function to include the new fields in audit logs
    - Add comments to document the new fields
*/

-- Add outdoor environmental columns to petri_observations
ALTER TABLE petri_observations
ADD COLUMN outdoor_temperature NUMERIC(5,2) NULL,
ADD COLUMN outdoor_humidity NUMERIC(5,2) NULL;

-- Add outdoor environmental columns to gasifier_observations
