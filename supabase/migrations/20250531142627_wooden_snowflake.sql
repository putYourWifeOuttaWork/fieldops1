...
-- Update or create triggers for user company management
...
-- 5. Update the handle_new_pilot_program function to set company_id
...
-- 6. Update RLS policies for company-based read access
...
-- 7. Create functions for company administration
