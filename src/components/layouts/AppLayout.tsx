  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      {showSessionIndicator && hasActiveSessions && (
        <div 
          className="fixed right-6 md:right-20 top-18 z-50 w-12 h-12 rounded-full bg-primary-600 shadow-lg flex items-center justify-center animate-pulse cursor-pointer"
