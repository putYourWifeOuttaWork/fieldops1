  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      {showSessionIndicator && hasActiveSessions && (
        <div 
          className="fixed right-9 md:right-[8vw] bottom-20 z-50 w-12 h-12 rounded-full bg-primary-600 shadow-lg flex items-center justify-center animate-pulse cursor-pointer"
